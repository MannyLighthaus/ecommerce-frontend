...
<template>
  <BContainer class="footer-container">
    <!-- brand and address -->
    <BRow class="col-12 brand-address-container">
      <BCol>
        <h2>Furniro.</h2>
      </BCol>
      <BCol>
    ...
    <!-- links -->
    <BRow class="nav-link-container">
      <BCol>
        <h3>Links</h3>
      </BCol>
      <Brow class="nav-links">
        <Bcol>
    ...
    <BRow>
      ...
      <BRow class="newsletter-input-container">
        <BCol>
        ...
        <hr style="height: 10px; background-color: blue; border: none" />
      </BRow>
    </BRow>
  </BContainer>
</template>
